...
class Header extends Component {
    ...
    await API.login(this.state.login)
      .then(response => {
        ...
        if (response.status !== 200)
          return console.log("Проблема з авторизацією");
  ...
  async registration() {
    ...
    if (
      this.state.registration.password !== this.state.registration.c_password
    ) {
    ...
    try {
      await API.register(this.state.registration)
        .then(response => {
          if (response.status !== 200)
            throw new Error("Проблема з реєстрацією");
          return response.json();
        })
        .then(res => {
          localStorage.setItem("userInfo", JSON.stringify(res.success));
  ...
  registrationView() {
    return (
      <Modal
        ...
        onClose={this.openRegonCloseModal}
        little
      >
          ...
          <div className="authorization">
            <div className="authGroup">
              <div className="authInputGroup row d-flex align-items-center justify-content-center">
                ...
                <input
                  value={this.state.registration.org_name}
                  onChange={e =>
                    this.onChangeRegistration("org_name", e.target.value)
                  }
                  type="text"
              ...
              <div className="authInputGroup row d-flex align-items-center justify-content-center">
                ...
                <input
                  ...
                  onChange={e =>
                    this.onChangeRegistration("name", e.target.value)
                  }
              ...
              <div className="authInputGroup row d-flex align-items-center justify-content-center">
                ...
                <input
                  ...
                  onChange={e =>
                    this.onChangeRegistration("email", e.target.value)
                  }
                />
              </div>
              <div className="authInputGroup row d-flex align-items-center justify-content-center">
                ...
                <input
                  ...
                  onChange={e =>
                    this.onChangeRegistration("password", e.target.value)
                  }
                />
              </div>
              <div className="authInputGroup row d-flex align-items-center justify-content-center">
                ...
                <input
                  ...
                  onChange={e =>
                    this.onChangeRegistration("c_password", e.target.value)
                  }
                />
              </div>
              <div className="authInputGroup row d-flex align-items-center justify-content-center">
                ...
                <input
                  type="text"
                  placeholder="Адреса організіції"
                  value={this.state.registration.org_address}
                  onChange={e =>
                    this.onChangeRegistration("org_address", e.target.value)
                  }
                />
              </div>
              <div className="authInputGroup row d-flex align-items-center justify-content-center">
                ...
                <input
                  ...
                  onChange={e =>
                    this.onChangeRegistration("phone", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className="row">
              <span className="consent">
                Реєстрація в системі означає згоду...
              </span>
            </div>
          </div>
        </div>
  ...
  authorizationView() {
    return (
      <Modal
        ...
        onClose={this.openAuthonCloseModal}
        little
      >
        <div className="header">
          <div className="authorizationHeader d-flex align-items-center justify-content-center">
          ...
          <div className="authorization">
            ...
            <div className="row">
              <div className="col-lg-3" style={{ padding: "0" }}>
                <div className="buttonEnter " onClick={() => this.login()}>
                  Увійти
                </div>
              </div>
  ...
  render() {
    let manufacts = this.state.manufacts.map(value => {
      ...
      let catArray = this.state.categories.filter(
        val => val.manufact_id === value.id
      );
