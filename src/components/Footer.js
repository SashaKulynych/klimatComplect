        ...
        <div className="container-fluid  footerContainer">
          <div className=" container_wrap">
            <div className="row ml-0 mr-0">
              ...
              <div
                style={{ margin: "auto" }}
                className="col-lg-6 col-sm-12  row d-flex justify-content-center footerCenter"
              >
                <div className="col-sm-12 col-lg-6 ">
                  <ul className="footerList">
                    ...
                    <li onClick={() => this.props.history.push("/Docm")}>
                      Обладнання
                    </li>
                ...
                <div className="col-sm-12 col-lg-6 ">
                  <ul className="contacts">
                    ...
                    <li>
                      <i className="fas fa-envelope contactIcons" />info@klimatkomplect.com.ua
                    </li>
                    <li>
                      <i className="fas fa-phone-volume contactIcons" />+38
                      (044) 379 10 90
                    </li>
                  </ul>
              ...
              <div
                style={{ margin: 0 }}
                className="col-lg-3 col-sm-12 row align-items-center justify-content-center"
              >
          ...
          <div
            className="col-12 text-center row"
            style={{
              position: "absolute",
              bottom: 1,
              display: "flex",
          ...
          >
            <a href="https://www.patprofi.com/">
              <img
                src={require("./images/logo_com.png")}
                style={{ height: 45 }}
              />
            </a>
            <div>
              <a
                href="https://www.patprofi.com/"
                style={{
                  color: "#fff",
              ...
              >
                {" "}
                Розробка сайту <br /> компанія P.A.T.Profi
              </a>
            </div>
          </div>
        </div>
